class Mailer < ActionMailer::Base
  ...
  def contact_us(title, name, email, tel, pcm, enquiry, department, heard_about, preferred_office)
    ...
    @body[:preferred_office] = preferred_office
    content_type "text/html"
  end

  def wills_enquiry(title, name, email, tel, enquiry)
    @completed_by       = name.blank? ? ("Someone") : (title.blank? ? name : title + " " + name)
